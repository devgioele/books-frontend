...
export const renderRoute = (route, key) => route.isProtected ?
  <ProtectedRoute key={key} exact={route.isExact} path={route.path} render={(props) =>
    (<route.component {...props} routes={route.routes} />)
  }
  />
  :
  <Route key={key} exact={route.isExact} path={route.path} render={(props) =>
    (<route.component {...props} routes={route.routes} />)
  }
  />
